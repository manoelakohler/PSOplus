...
namespace PSO.ParticlesLC
{
    ...
    /// </summary>
    public abstract class ParticleSwarmLC
    {
        #region Variables
        ...
        /// </summary>
        public ParticleLC[] Particles { get; set; }
        //---------------------------------------------------------------------
        /// <summary>
        /// Indexer.
        /// </summary>
        public ParticleLC this[int index]
        {
        ...
        public bool UseArithmeticReposition { get; set; }
        ...
        protected ParticleSwarmLC(double tendencyToOwnBest, double tendencyToGlobalBest, double momentum)
        {
        ...
        public virtual void Iteration(int iteration)
        {
            ...
            foreach (var particle in localParticles)
                particle.UpdateVelocityAndPosition(_useGlobalOptimum ? BestPosition : this[0].Position, Constraints);
        }
