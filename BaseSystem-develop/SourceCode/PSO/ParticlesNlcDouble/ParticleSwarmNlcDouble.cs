...
namespace PSO.ParticlesNlcDouble
{
    ...
    /// </summary>
    public abstract class ParticleSwarmNlcDouble
    {
        #region Variables
        ...
        /// </summary>
        public ParticleNlcDouble[] SearchParticles { get; set; }
        
        /// <summary>
        /// The particles of this swarm.
        /// </summary>
        public ParticleNlcDouble[] ReferenceParticles { get; set; }

        public ParticleNlcDouble[] FootHolds { get; set; }
        
        //---------------------------------------------------------------------
        /// <summary>
        /// Indexer.
        /// </summary>
        public ParticleNlcDouble this[int index]
        {
        ...
        public double[] CurrentBestPosition { get { return /*this[0].Position*/ ReferenceParticles[0].Position; } }
        //---------------------------------------------------------------------
        /// <summary>
        ...
        protected ParticleSwarmNlcDouble(double tendencyToOwnBest, double tendencyToGlobalBest, double momentum)
        {
        ...
        protected ParticleSwarmNlcDouble()
        {
            //BestCost = double.MaxValue; 
        ...
        public void UpdateCostAndHistoryCv()
        {
            // Update history of the swarm:
            if (!(SearchParticles[0].Cost <= BestCost)) return;
            
            BestCost = SearchParticles[0].Cost;
            BestPosition = SearchParticles[0].BestPosition;
        }
        //---------------------------------------------------------------------
        /// <summary>
        ...
        public virtual void IterationCv(int iteration)
        {
        }
